...
// both arches), or the verify/fold paths diverge.
...
// (M1: the P3 T2 table twin k_conv_step_t retired with the role rotation --
// the fused path runs the same lane-0 + chunk launches as solo.)
...
// (M1: the P3 T2 table twin k_delta_step_t retired with the role rotation.)
